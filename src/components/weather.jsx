    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="w-[80%] mt-[10vh]">
          ...
          <div className="flex ml-[13vw] mt-[0.3vw] w-[26.042vw] mb-[0.5vh]">
            ...
            <p className="text-[1.042vw] ml-[0.156vw]">
              ...
              <strong>{weather.visibility}m</strong>, and feels like temperature
              of <strong>{Math.round(weather.main?.feels_like)}°</strong>.
          ...
          <h4 className="text-[3.5vw] bg-clip-text text-transparent bg-gradient-to-r from-[#87CEEB] to-[#E0FFFF]  w-[40vw] justify-center items-center mx-[30vw] drop-shadow-xl outline-5">
            Weekly Forecast
          </h4>
          {/* Forecast Deatils */}
